...
export const mockEnergyData: { hourly: EnergyReading[]; daily: EnergyReading[]; weekly: EnergyReading[] } = {
  hourly: Array.from({ length: 24 }, (_, i) => ({
    ...
    value: i >= 9 && i <= 17 ? 0.35 : 0.05,
  })),
  daily: [
    { time: 'Mon', value: 3.2 }, { time: 'Tue', value: 2.8 },
    { time: 'Wed', value: 3.4 }, { time: 'Thu', value: 2.9 },
    { time: 'Fri', value: 3.1 }, { time: 'Sat', value: 0.8 },
    { time: 'Sun', value: 0.4 },
  ],
  weekly: [
    { time: 'Week 1', value: 16.2 }, { time: 'Week 2', value: 15.8 },
    { time: 'Week 3', value: 16.9 }, { time: 'Week 4', value: 14.4 },
  ],
};
